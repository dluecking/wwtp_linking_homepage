...
# read vph data -----------------------------------------------------------
vph_df <- fread("data/vph_data.csv")

# read plv data -----------------------------------------------------------
plv_df <- fread("data/plv_data.csv")
...
## Network Clusters
Select a NCV/VPH/PLV-centered network cluster from the menu below to explore the data interactively.

<label for="plotSelector"><strong>Select cluster plot:</strong></label>
<select id="plotSelector">
  <option value="">-- choose a plot --</option>
  # <option value="Fred_8_interactive.html">Fred_8_interactive.html</option>
  {{< include options.html >}}
</select>

<!-- Hidden iframe initially -->
<iframe id="plotFrame" 
        style="border:0px solid #ccc; display:none; width:100%; height:600px">
</iframe>
